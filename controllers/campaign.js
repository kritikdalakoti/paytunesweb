...
exports.editlineitem = async (req, res) => {
	try {
		...
		let updated = await Lineitem.findOneAndUpdate(
			{ _id: lineitemid },
			{ $set: { dealid, lineitemname } },
			{ new: true }
		);

		if (!updated) return res.status(400).json({ error: "Couldn't Update!" });
		console.log(updated);
...
// 			AudioFrequency,
// 			VideoFrequency,
// 			DisplayFrequency, //done
// 			AudioTimeperiod,
// 			VideoTimeperiod,
// 			DisplayTimeperiod, //done
// 			Audioactive,
// 			Videoactive,
// 			Displayactive, //done
// 			AudioRegion,
...
// 			Audioage,
// 			Videoage,
// 			Displayage, //need  to ask

// 			AudioGrandCityval,
// 			VideoGrandCityval,
// 			DisplayGrandCityval, //done
// 			Audiocityval,
// 			Videocityval,
// 			Displaycityval,
// 			Audiogender,
...
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.AudioFileinp[0].filename}`
// 			);
// 			console.log(data);
...
// 			console.log('ss');
// 			let data = fs.readFileSync(
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.VideoFileinp[0].filename}`
// 			);
// 			let date = new Date();
...
// 			let data = fs.readFileSync(
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.DisplayFileinp[0].filename}`
// 			);
// 			let date = new Date();
// 			const year = date.getFullYear();
// 			let month;
...
// 			let data = fs.readFileSync(
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.AudioFileBanner[0].filename}`
// 			);
// 			let date = new Date();
// 			const year = date.getFullYear();
// 			let month;
...
// 			let data = fs.readFileSync(
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.VideoFileBanner[0].filename}`
// 			);
// 			let date = new Date();
// 			const year = date.getFullYear();
// 			let month;
...
// 			let data = fs.readFileSync(
// 				`${path.join(__dirname, '../public/uploads/')}${req.files.DisplayFileBanner[0].filename}`
// 			);
// 			let date = new Date();
// 			const year = date.getFullYear();
// 			let month;
...
// 								Title: Audiocreative,
// 								type: 'Audio',
// 								MediaFiles: req.files.AudioFileinp ? AudioMediaFiles : [ {} ]
// 							}
// 						],
// 						strategy: strategy,
// 						Companion: req.files.AudioFileBanner
// 							? [
// 									{
// 										Title: Audiocreative,
// 										type: 'Audio',
// 										imageFiles: req.files.AudioFileBanner
// 											? [ { Name: req.files.AudioFileBanner[0].filename } ]
// 											: [ {} ]
// 									}
// 								]
// 							: [ {} ]
...
// 								Title: Videocreative,
// 								type: 'Video',
// 								MediaFiles: req.files.VideoFileinp ? VideoMediaFiles : [ {} ]
// 							}
// 						],
// 						strategy: strategy,
// 						Companion: req.files.VideoFileBanner
// 							? [
// 									{
// 										Title: Videocreative,
// 										imageFiles: req.files.VideoFileBanner
// 											? [ { Name: req.files.VideoFileBanner[0].filename } ]
// 											: [ {} ]
// 									}
// 								]
// 							: [ {} ]
...
// 						Companion: req.files.DisplayFileBanner
// 							? [
// 									{
// 										Title: Displaycreative,
// 										type: 'Display',
// 										imageFiles: req.files.DisplayFileBanner
// 											? [ { Name: req.files.DisplayFileBanner[0].filename } ]
// 											: [ {} ]
// 									}
// 								]
// 							: [ {} ],
