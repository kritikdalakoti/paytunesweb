		...
		<UserContext.Provider value={{ state, dispatch }}>
			<BudgetContext.Provider value={{ state1, dispatch1 }}>
				<MainContext.Provider value={{ statemain, dispatchmain }}>
					<div className="App">
						<BrowserRouter>
							<Route path="/login" render={() => (state ? <Redirect to="/" /> : <Login />)} exact />
							<Route
								path="/"
								exact
							...
							{state && (
								<React.Fragment>
									...
									<Route path="/insertion/:campid" render={() => <Insertion />} exact />
									<Route path="/lineitemnew/:insertionid" render={() => <LineItemNew />} exact />
									<Route path="/advertisers" render={() => <Advertiser />} exact />
									<Route path="/listlineitem/:campid" render={() => <ListLineitem />} exact />
									<Route path="/advertiser/new" render={() => <Create_Advertiser />} />
									<Route path="/advertisers/new/user" render={() => <Create_User />} />
									<Route path="/advertisers/user/update/:user" render={() => <Update_User />} />
									<Route
										path="/advertisers/advertiser/update/:advertiser"
										render={() => <Update_Advertiser />}
									/>
									<Route path="/dashboard/new/campaign" render={() => <NewCampaign />} exact />
									<Route path="/dashboard/c/campaign/new/:campid" render={() => <LineItem />} />
