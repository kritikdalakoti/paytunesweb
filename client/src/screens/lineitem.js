...
const LineItem = () => {
	...
	function submitsubcampaign() {
		...
		axios
			.post(
				'/campaign/createsubcampaign', //http://127.0.0.1:5000
				formdata,
				{
					headers: {
				...
				>
					<TabPanel value={value} index={0}>
						...
						<div class={styles.svdef}>
							<button class="button-footer2" tabIndex="0" onClick={() => handleChange({}, value + 1)}>
					...
					<TabPanel value={value} index={1}>
						<Tab2
							state={{
								...
								setAudioimpressionlimit,
								Videoimpressionlimit,
								setVideoimpressionlimit,
								Displayimpressionlimit,
								setDisplayimpressionlimit,
								Audiostartdate,
								setAudiostartdate,
								Videostartdate,
								setVideostartdate,
						...
						<div class={styles.svdef}>
							<button class="button-footer2" tabIndex="0" onClick={() => handleChange({}, value + 1)}>
								Next: Upload or Assign your Creative
							</button>
						</div>
					</TabPanel>
					...
					<TabPanel value={value} index={2}>
						<Tab3
							state={{
								...
								setDisplaytrackurl,
								Audiocategorytype,
								setAudiocategorytype,
								Videocategorytype,
								setVideocategorytype,
								Displaycategorytype,
								setDisplaycategorytype,
								AudioFileinp,
								setAudioFileinp,
								VideoFileinp,
								setVideoFileinp,
								...
								setVideoFileBanner,
								DisplayFileBanner,
								setDisplayFileBanner,
								tempAudioFileinp,
								settempAudioFileinp,
								tempVideoFileinp,
								settempVideoFileinp,
								tempDisplayFileinp,
								settempDisplayFileinp,
								Audioimpurl,
								setAudioimpurl,
								Videoimpurl,
								setVideoimpurl,
					...
					<TabPanel value={value} index={3}>
						<Tab4
							state={{
								...
								setDisplayimpurl,
								AudioGrandCityval,
								setAudioGrandcityval,
								VideoGrandCityval,
								setVideoGrandcityval,
								DisplayGrandCityval,
								setDisplayGrandcityval
							}}
						/>
						<div class={styles.svdef}>
							<div className={styles.vftuc_sub}>
								...
								>
									...
									/>
									<label for={`activeyes`} style={{ paddingRight: '10px', width: '10%' }}>
										Yes
									</label>
									...
									<input
										...
										name={`ActiveNo`}
										value="false"
										checked={active === 'false' ? true : false}
									/>
									<label for={`inActiveno`} style={{ paddingRight: '10px', width: '10%' }}>
										No
									</label>
								</div>
							</div>
				...
				<TabPanel value={value} index={4}>
					<Tab5
						state={{
							...
							submitsubcampaign,
							AudioLtbudgetcheck,
							setAudioLtbudgetcheck,
							VideoLtbudgetcheck,
							setVideoLtbudgetcheck,
							DisplayLtbudgetcheck,
							setDisplayLtbudgetcheck,
							Audioimpressionlimitcheck,
							setAudioimpressionlimitcheck,
							Videoimpressionlimitcheck,
							setVideoimpressionlimitcheck,
							Displayimpressionlimitcheck,
							setDisplayimpressionlimitcheck,
							Audiostartdatecheck,
							setAudiostartdatecheck,
							Videostartdatecheck,
							setVideostartdatecheck,
							Displaystartdatecheck,
							setDisplaystartdatecheck,
							Audioenddatecheck,
							setAudioenddatecheck,
							Videoenddatecheck,
							setVideoenddatecheck,
							Displayenddatecheck,
							setDisplayenddatecheck,
							Audiostarttimecheck,
							setAudiostarttimecheck,
							Videostarttimecheck,
							setVideostarttimecheck,
							Displaystarttimecheck,
							setDisplaystarttimecheck,
							Audioendtimecheck,
							setAudioendtimecheck,
							Videoendtimecheck,
							setVideoendtimecheck,
							Displayendtimecheck,
							setDisplayendtimecheck,
							Audiocreativecheck,
							setAudiocreativecheck,
							Videocreativecheck,
							setVideocreativecheck,
							Displaycreativecheck,
							setDisplaycreativecheck,
							Audiosizecheck,
							setAudiosizecheck,
							Videosizecheck,
							setVideosizecheck,
							...
							setDisplaysizecheck,
							Audiotrackurlcheck,
							setAudiotrackurlcheck,
							Videotrackurlcheck,
							setVideotrackurlcheck,
							Displaytrackurlcheck,
							setDisplaytrackurlcheck,
							AudioFrequencycheck,
							setAudioFrequencycheck,
							VideoFrequencycheck,
							setVideoFrequencycheck,
							DisplayFrequencycheck,
							setDisplayFrequencycheck,
							AudioTimeperiodcheck,
							setAudioTimeperiodcheck,
							VideoTimeperiodcheck,
							setVideoTimeperiodcheck,
							DisplayTimeperiodcheck,
							setDisplayTimeperiodcheck,
							AudioRegioncheck,
							setAudioRegioncheck,
							VideoRegioncheck,
							setVideoRegioncheck,
							DisplayRegioncheck,
							setDisplayRegioncheck,
							Audioagecheck,
							setAudioagecheck,
							Videoagecheck,
							setVideoagecheck,
							...
							setDisplayagecheck,
							Audiocityvalcheck,
							setAudiocityvalcheck,
							Videocityvalcheck,
							setVideocityvalcheck,
							Displaycityvalcheck,
							setDisplaycityvalcheck,
							Audiogendercheck,
							setAudiogendercheck,
							Videogendercheck,
							setVideogendercheck,
							Displaygendercheck,
							setDisplaygendercheck,
							AudioLanguagecheck,
							setAudioLanguagecheck,
							VideoLanguagecheck,
							setVideoLanguagecheck,
							DisplayLanguagecheck,
							setDisplayLanguagecheck,
							Audiocategorycheck,
							setAudiocategorycheck,
							Videocategorycheck,
							setVideocategorycheck,
							Displaycategorycheck,
							setDisplaycategorycheck,
							Audiooscheck,
							setAudiooscheck,
							Videooscheck,
							setVideooscheck,
							...
							setDisplayoscheck,
							Audiomakemodelcheck,
							setAudiomakemodelcheck,
							Videomakemodelcheck,
							setVideomakemodelcheck,
							Displaymakemodelcheck,
							setDisplaymakemodelcheck,
							Audioareacheck,
							setAudioareacheck,
							Videoareacheck,
							setVideoareacheck,
							...
							setDisplayareacheck,
							AudioPincodecheck,
							setAudioPincodecheck,
							VideoPincodecheck,
							setVideoPincodecheck,
							DisplayPincodecheck,
							setDisplayPincodecheck,
							audiodayscheck,
							setaudiodayscheck,
							videodayscheck,
							setvideodayscheck,
							...
							setVideoimpurlcheck,
							Displayimpurlcheck,
							setDisplayimpurlcheck,
							AudioGrandCityvalcheck,
							setAudioGrandCityvalcheck,
							VideoGrandCityvalcheck,
							setVideoGrandCityvalcheck,
							DisplayGrandCityvalcheck,
							setDisplayGrandCityvalcheck,
							map1,
							Audiostrategycheck,
							setAudiostrategycheck,
							Videostrategycheck,
							setVideostrategycheck,
							Displaystrategycheck,
							setDisplaystrategycheck,
							Audiosubcampnamecheck,
							setAudiosubcampnamecheck,
							Videosubcampnamecheck,
							setVideosubcampnamecheck,
							Displaysubcampnamecheck,
							setDisplaysubcampnamecheck
						}}
					/>
					{/* </form> */}
				</TabPanel>
