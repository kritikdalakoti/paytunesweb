...
import { data, region, ages, language, Category_List, MakeModel,grandcity_data } from '../utils/state';
...
export function Tab4({state}) {
    ...
    let {AudioFrequency,setAudioFrequency,VideoFrequency,setVideoFrequency,DisplayFrequency,setDisplayFrequency,
        ...
        // AudioisUploadRegion,setAudioisUploadregion,VideoisUploadRegion,setVideoisUploadRegion,DisplayisUploadRegion,
        // setDisplayisUploadRegion
    }=state
    ...
    console.log(Audiocheck,Videocheck)
        ...
        <div>
            ...
            {state1.Type.map((typ) =>
                <Grid container className={classes.root1} >
                    ...
                    <button class="button-footer2" tabIndex="0"  style={{marginRight:'40px',marginLeft:'140px',padding:'20px 40px 20px 40px'}} onClick={()=>
                    typ === "Audio" ? setAudiocheck(1) : (typ === "Video" ? setVideocheck(1) : setDisplaycheck(1))
                    } >Pincode Upload</button>
                    <button class="button-footer2" tabIndex="0"  style={{marginLeft:'140px',padding:'20px 40px 20px 40px'}} onClick={()=>
