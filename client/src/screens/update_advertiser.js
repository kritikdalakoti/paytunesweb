...
export default function Update_Advertiser(){
  ...
  function update_advertiser(){
    fetch('/advertiser/update_advertiser',{  //http://127.0.0.1:5000
      method:'PATCH',
  ...
  useEffect(()=>{
    fetch('/advertiser/get_advertiser',{  //http://127.0.0.1:5000
        method:'POST',
        headers:{"Content-Type":"application/json","Authorization" :"Bearer "+localStorage.getItem("jwt")},
    ...
    return(
        <Paper id="rcorners2"  className='dashboard' elevation={3}>
              ...
              <div class={styles.heading} > <h1>Update Advertiser</h1> </div>
        ...
        {/* <br/><br/><br/> */}
          ...
          <button class={styles.button1} >Update Advertiser</button>
